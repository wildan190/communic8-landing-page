                    ...
                    <form action="{{ route('clients.update', $client) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <select name="category"
                                ...
                                <option value="1" {{ $client->category == '1' ? 'selected' : '' }}>Category 1
                                </option>
                                <option value="2" {{ $client->category == '2' ? 'selected' : '' }}>Category 2
                                </option>
                                <option value="3" {{ $client->category == '3' ? 'selected' : '' }}>Category 3
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="flex justify-end">
                            ...
                            <button type="submit"
                                class="ml-3 px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">Update</button>
                        </div>
                    </form>
                </div>
            </div>
