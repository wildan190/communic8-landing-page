        ...
        <nav class="hidden md:flex items-center space-x-8 text-gray-700 font-medium relative">
            ...
            <div class="relative group">
                ...
                <div class="absolute left-0 mt-2 w-48 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                    <a href="{{ route('layanan.brand-forge') }}" class="block px-4 py-2 hover:bg-orange-50 hover:text-orange-500">{{ __('navbar.brand_forge') }}</a>
                    <a href="{{ route('layanan.digital-compass') }}" class="block px-4 py-2 hover:bg-orange-50 hover:text-orange-500">{{ __('navbar.digital_compass') }}</a>
                    <a href="{{ route('layanan.digital-architecture') }}" class="block px-4 py-2 hover:bg-orange-50 hover:text-orange-500">{{ __('navbar.digital_architecture') }}</a>
                    <a href="{{ route('layanan.public-presence') }}" class="block px-4 py-2 hover:bg-orange-50 hover:text-orange-500">{{ __('navbar.digital_presence') }}</a>
                </div>
            </div>
            ...
            <a href="{{ route('contact.index') }}" class="bg-gray-800 text-white px-5 py-2 rounded-full hover:bg-gray-700">{{ __('navbar.contact') }}</a>
