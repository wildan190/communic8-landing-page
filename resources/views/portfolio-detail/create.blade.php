    ...
    <div class="py-6">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('portfolio-detail.store') }}" method="POST" enctype="multipart/form-data"
                    class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <input type="text" id="client_name"
                                ...
                                placeholder="Select a client..." readonly>
                        ...
                        <div class="result-item border p-4 rounded-md bg-gray-50 dark:bg-gray-900">
                            <div>
                                <label class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Result
                                    Name</label>
                                <input type="text" name="results[0][name]"
                                    class="w-full border-gray-300 rounded-md shadow-sm">
                            </div>
                            ...
                            <div class="mt-3">
                                <label class="block text-gray-700 dark:text-gray-300 font-semibold mb-1">Result
                                    Image</label>
                                <input type="file" name="results[0][result_img]"
                                    class="w-full border-gray-300 rounded-md shadow-sm">
                            </div>
                        </div>
                    </div>
...
====================== --}}
    <div id="clientModal" class="hidden fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center">
        <div class="bg-white dark:bg-gray-800 w-full max-w-5xl rounded-lg shadow-lg p-6">
            ...
            <div class="flex justify-between items-center mt-4 text-sm text-gray-700 dark:text-gray-300">
                ...
                <div class="space-x-2">
                    <button id="prevPage"
                        class="px-3 py-1 border rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">Prev</button>
                    <button id="nextPage"
                        class="px-3 py-1 border rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">Next</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('add-result').addEventListener('click', function() {
            ...
            newItem.innerHTML = `
            <button type="button" class="remove-result absolute right-2 top-2 text-red-600 text-sm">✕ Remove</button>
