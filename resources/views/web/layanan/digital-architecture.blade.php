        ...
        <div class="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 flex justify-start">
            <div class="max-w-xl text-left">
                ...
                <p class="mt-3 text-sm md:text-base text-gray-700 font-rubik leading-relaxed max-w-md">
                    Communic 8 brings creativity and code together to develop engaging websites, intuitive applications, and
            ...
            <div class="text-gray-800 font-rubik leading-relaxed space-y-6 flex flex-col justify-between">
                <div>
                    <p>
                        ...
                        foundation of how audiences experience and connect with you. That’s why at Communic 8, our Digital
                        Development solutions are designed not just to build digital assets, but to create experiences that
                        are meaningful, scalable, and future-ready.
                    </p>

                    <p>
                        Our process begins with strategic planning and research, ensuring every solution is grounded in
                        business objectives and market insights. We then move into UX research and information architecture,
                        structuring intuitive user journeys that make every interaction seamless. From there, our team designs
                        elegant and functional UI/UX interfaces before translating them into reliable, high-performing platforms
                        through application development and coding. Each product undergoes rigorous testing and quality
                        assurance to guarantee stability and usability, followed by precise deployment and launch to ensure readiness
                        for the market.
                    </p>
                    ...
                    <p>
                        ...
                        It’s about aligning technology dengan brand strategy, ensuring every platform is not only functional but
...
<section class="w-full py-20 bg-white">
    <div class="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
